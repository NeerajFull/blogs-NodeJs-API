...
const getAllBlogs = async (req, res) => {
    try {
        ...
        const blogs = await blogModel.find({}).populate("user", "username _id");
        if (!blogs) {
...
module.exports = { userBlogController, getAllBlogs, createBlogController, updateBlogController, deleteBlogController, getBlogByIdController };